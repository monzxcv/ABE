...
class MSP:
    ...
    def createPolicy(self, policy_string):
        ...
        assert type(policy_string) in [str], "invalid type for policy_string"
    ...
    def _convert_policy_to_msp(self, subtree, curr_vector):
        ...
        if type == OpType.ATTR:
            #print ('ATTR: ', subtree, subtree.getAttributeAndIndex(), curr_vector)
        ...
        if type == OpType.AND:
            ...
            #print ('AND l: ', left_list, 'r: ', right_list)
            left_list.update(right_list)
            return left_list
